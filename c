...
<h3>Language Technology</h3>: Lexical databases; Discourse Analysis; Sentiment Analysis Controlled Vocabularies; Corpus Annotation; Information Extraction; Topic Modelling; Word Sense Disambiguation; Data Modelling; IOB Tags; BNC Corpora; CAT Tools; WordNet; Lexicography; Praat; ADAM; British National Corpus (BNC); Terminology Databases (UNTERM; IATE; World Server; MultiTerm); Terminology Maintenance; Terminology Triage.
<h3>Software Tools</h3>: Agile; CMS; Jira; XML; HTML; SQL; BigQuery; Sparql; Bixby Studio; Keywords Manager; Machine Translation; Multi Corpora; Keywords Manager; Open Data; SharePoint; Perforce; Python; NLTK; TextBlob; Spacy; RDF; Wikidata; MetaTags; Skos.
...
<h2>Project: Corpus Classification for AI</h2>
